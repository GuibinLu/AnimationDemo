...
-(void)initUI
{
    ...
    self.textView = [[DrawTextView alloc]initWithFrame:CGRectMake(CGRectGetMidX(self.view.frame)- 100, 100, 200, 200) String:@"A12312312" font:[UIFont systemFontOfSize:60]];
